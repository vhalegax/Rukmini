      ...
      <li class="nav-item {{Request::path() == 'karyawan/users' ? 'active' : ''}}">
        ...
        <div id="karyawan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('users.index')}}">Daftar Karyawan</a>
            <a class="collapse-item" href="{{route('users.create')}}">Tambah Karyawan</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 140707801 </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
