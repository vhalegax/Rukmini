...
<section>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top:70px;">
        ...
        <div class="carousel-inner">
            ...
            <img class="d-block w-100" src="{{asset('frontend/img/1.jpg')}}" style="height:100%; width:100%;" alt="First slide">
            </div>
            <div class="carousel-item gambargerak">
            <img class="d-block w-100" src="{{asset('frontend/img/2.jpg')}}" style="height:100%; width:100%;" alt="Second slide">
            </div>
            <div class="carousel-item gambargerak">
            <img class="d-block w-100" src="{{asset('frontend/img/3.jpg')}}"  style="height:100%; width:100%;" alt="Thrid slide">
            </div>
        </div>
        ...
        <div class="container">
            <div class="row pt-5">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 text-center pb-5" style="height:300px;">
                    <img src="{{asset('frontend/img/fit-guide.png')}}" alt="" height="90px" width="90px">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 text-center pb-5" style="height:300px;">
                    <img src="{{asset('frontend/img/easy-return.png')}}" alt="" height="90px" width="90px">
